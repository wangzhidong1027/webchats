...
//		 console.log(this.favorablePrice)
//		 console.log(typeof this.paymoney)
//		 console.log(typeof this.favorablePrice)
...
//	  		},
		...
		//点击确定
			determines(){
				 if(this.checkid){
					//console.log(this.checkid.money)
				 	this.csh=false
				 	this.showhide=true
				 	this.quany=true
				 }else{
