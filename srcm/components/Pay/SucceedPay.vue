<template>
	<div class="succeed-pay">
		<div class="pay-tittle">
			<div class="pay-img" v-if='!(this.order.orderPayed < this.order.orderMoney&&this.order.payway==25)'>
			...
			<div class="pay-num"  >
				<div v-if='!(this.order.orderPayed < this.order.orderMoney&&this.order.payway==25)'>
					<p>支付金额(元)</p>
					<h3>{{order.orderPayed}}</h3>
				</div>
		</div>
		</div>
		<div v-if="this.order.orderPayed < this.order.orderMoney&&this.order.payway==25" class="wxpay">
