<template>
    <div class="goodslist">
      ...
      <div class="scoll" >
      <mt-loadmore :bottom-method="loadBottom" :auto-fill="false" :bottomLoadingText='""' :bottomDropText='""' :bottomPullText='""' :bottomDistance=50 ref="loadmore">
        <div v-show="show" class="allgoods" >
          <!--<div >-->
            ...
            <list v-if="goods.length" :type='this.type' :goods=goods :imgpath="imgpath"  :getmore="getmore"></list>
          </div>
        <!--</div>-->
      </mt-loadmore>
        </div>
  ...
  export default {
    ...
    methods: {
      ...
      getmore() {
        this.page++;
        var that = this
        var arr = Base64.decode(this.$route.params.id).split('&')
