		 		...
		 		<!--	<div @click="zengpinshow" class="satisfy"> <img src="../assets/images/satisfy.jpg" alt="" /></div>-->
		 			<div class="car-goods" v-for="(item,index) in cargoods[0].carlist">
				 				...
				 				<div class="goods-name">
				 					...
				 					<p class="weight">属性：<span>{{item.options}}</span></p>
				 					<div class="goods-tlt">
				 						<div class="price">¥&nbsp;<b>{{item.frontPrice}}</b></div>
				 						<div class="went-number"><span class="minus"><b @click="reduceNumber([0,index,item.number-1])">-</b></span><input class="idnumber" v-model="item.number" type="text" @blur='oba([0,index,item.number])' /><span class="add"><b @click=addNumber([0,index,(item.number*10+10)/10])>+</b></span></div>
				 					</div>
				 				</div>
			 		</div>
            <!--<div class="car-goods">
        ...
        <div class="car-sort" v-if="cargoods[1].carlist.length">
          ...
          <div class="car-goods" v-for="(item,index) in cargoods[1].carlist">
            ...
            <div class="goods-name">
              ...
              <div class="goods-tlt">
                <div class="price">¥&nbsp;<b>{{item.frontPrice}}</b></div>
                <div class="went-number"><span class="minus"><b @click="reduceNumber([1,index,item.number-1])">-</b></span><input class="idnumber" v-model="item.number" type="text" @blur='oba([1,index,item.number])'/><span class="add"><b @click=addNumber([1,index,(item.number*10+10)/10])>+</b></span></div>
              </div>
            </div>
          </div>
        </div>
        <div class="car-sort" v-if="cargoods[2].carlist.length">
          ...
          <div class="car-goods" v-for="(item,index) in cargoods[2].carlist">
            ...
            <div class="goods-name">
              ...
              <div class="goods-tlt">
                <div class="price">¥&nbsp;<b>{{item.frontPrice}}</b></div>
                <div class="went-number"><span class="minus"><b @click="reduceNumber([2,index,item.numbers-1])">-</b></span><input class="idnumber" v-model="item.number" type="text" @blur='oba([2,index,item.number])' /><span class="add"><b @click=addNumber([2,index,(item.number*10-10)/10])>+</b></span></div>
