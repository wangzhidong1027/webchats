<template>
  <div id="mobile">
    ...
    <p class="miane"><a :class="type=='phoneCharge'? 'active':''" @click="changeType('phoneCharge')">话费充值</a><a :class="type=='GPRS'? 'active':''" @click="changeType('GPRS')">流量充值</a></p>
...
const Phone = {
  ...
  methods: {
    changeType(str) {
      if(str=="GPRS"&&!(/^1[3|4|5|8][0-9]\d{4,8}$/.test(this.mobile))){
