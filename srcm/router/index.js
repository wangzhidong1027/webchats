...
import Searchpage from '@/components/JD/Searchpage'
...
import Settlement from '@/components/Bystages/settlement'
import Receivables from '@/components/Bystages/receivables'
...
//	mode: 'history',
    ...
    {path:'/jpay',name: 'J_pay',component: J_pay,
      children:[
        ...
        {path: '/jpay/quick/quickpay/:oriderid/:cardid', name: 'QuickPay', component:QuickPay },
        {path: '/jpay/quick/quickpay/sccessful/:orideerid', name: 'Sccessful', component:Sccessful },
